...
public class TestHelloWorld {
  ...
  public void getMessageInList() { // this test is broken - fix it!
    ...
    assertEquals("hello world", list.get(0).getMessage()); //indexing issue, list only has one element
  }

  @Test
  public void getYearInList() { // this test is broken - fix it!
    var list = Arrays.asList(fixture);
    assertEquals(2025, list.get(0).getYear()); //indexing issue, list only has one element
  }
}
